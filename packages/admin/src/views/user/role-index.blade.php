...
@section('content')
    ...
    <div class="col-xs-12">
        ...
        @endif
        <a class="btn btn-primary pull-right" data-toggle="modal" data-target="#add-permission" style="margin-bottom: 10px">添加角色</a>
    </div>
                ...
                <form action="{{url('admin/role/create')}}" method="post" class="form-horizontal">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" id="form-field-1" placeholder="角色标示" class="col-xs-10 col-sm-10">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea name="description" id="" class="col-xs-10 col-sm-10" rows="5"></textarea>
                            </div>
                        </div>
                        <div class="space-4"></div>
                        <div class="form-group">
