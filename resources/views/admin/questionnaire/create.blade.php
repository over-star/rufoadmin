        ...
        <form action="{{route('questionnaire.store')}}" method="post" class="form-horizontal">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="title" value="" placeholder="问卷标题" class="form-control col-xs-10 col-sm-10">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="col-xs-10 col-sm-10 form-control" name="description" id="" cols="30" rows="5"></textarea>
                    </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <label class="checkbox-inline">
                            <input type="checkbox" name="lang[]" value="en"> 英语
                        </label>
                    </div>
                </div>
