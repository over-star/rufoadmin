...
Source Host           : 192.168.33.110:3306
Source Database       : ace
...
CREATE TABLE `menus` (
  ...
  `active_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '选中的url',
...
INSERT INTO `menus` VALUES ('19', '编辑env文件', 'system/env/index', 'system/env/index', null, '7', '0', '7', '2017-07-09 16:20:04', '2017-07-09 16:20:04');
INSERT INTO `menus` VALUES ('20', '查看日志', 'log-viewer/logs', 'log-viewer/logs', null, '0', '0', '0', '2017-07-11 14:43:01', '2017-07-11 14:43:01');
...
-- Records of options
-- ----------------------------
INSERT INTO `options` VALUES ('3', 'plugins_enabled', '[\"edit-env\"]');
...
CREATE TABLE `questionnaire` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `lang` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '多语言标志字段',
  PRIMARY KEY (`id`),
...
CREATE TABLE `questionnaire_question` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `group_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '多语言标志字段',
  `lang` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '语言',
  PRIMARY KEY (`id`),
...
-- ----------------------------
INSERT INTO `questionnaire_question` VALUES ('5', '6', 'sdfs', 'sdf s', '0', '1', '2017-07-11 15:33:56', '2017-07-11 15:55:00', '5a35e358-664e-11e7-af68-080027c30a85', 'zh');
...
CREATE TABLE `questionnaire_question_item` (
  ...
  `mark` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'ABCD等标识',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '选项标题',
  `right_key` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否是正确答案，1是正确答案',
  `addition` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '附加条件',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `group_number` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '多语言标志字段',
  `lang` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '语言',
...
-- ----------------------------
INSERT INTO `questionnaire_question_item` VALUES ('9', '5', 'sdfs', 'sdf', '0', '', '2017-07-11 15:55:00', '2017-07-11 15:55:00', '5a35e358-664e-11e7-af68-080027c30a85', 'zh');
INSERT INTO `questionnaire_question_item` VALUES ('10', '6', 'dxc', 'xcv', '0', '', '2017-07-11 15:55:00', '2017-07-11 15:55:00', '5a35e358-664e-11e7-af68-080027c30a85', 'en');
...
CREATE TABLE `users` (
  ...
  `auth_info` text COLLATE utf8mb4_unicode_ci,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('1', 'rufo', '123456@qq.com', '$2y$10$2rq7E0aZvfAsovV2wT0N/uZHtP9vQjaFl8GZgv4bv.1XbyQqrxKSG', 'hwOLXG31mnAeHVexXHoaFzhu8b8s2fixULDMalZ7srLhIAU8rqan2T53MoPr', '2017-05-21 18:29:32', '2017-05-21 18:29:32', null, null, null, null, null);
